public class Idman {
    ...
    public void burpeeYap(int sayi)
    {
        ...
        {
            System.out.println("Hedeflenen sayıyı geçtiniz. Tebrikler.");
            burpee_sayisi = 0;
            System.out.println("\nKalan burpee : " + burpee_sayisi);
        }
        else
        {
            burpee_sayisi -= sayi ;
